...
Pokemon::Pokemon(std::string name, int ps, int atk, int def, int spatk,
  int spdef, int speed, std::string type1, std::string type2, /*std::vector<Moves*> moves, */
  int level)
